...
class Element{
    ...
    public :
        //---constructeur
        Element(Mesh *mesh, const glm::vec3 position = glm::vec3(0.f,0.f,0.f), const glm::vec3 size = glm::vec3(1.f,1.f,1.f), const glm::vec3 rotation = glm::vec3(0.f,0.f,0.f));
        ...
        //draw
        void draw(const glm::mat4 &ProjMatrix, const glm::mat4 &ViewMatrix, const bool isBind = true);

        //getters
        virtual glm::mat4 MVMatrix() const;
