...
int main(int argc, char** argv) {
    ...
    texturePath = applicationPath.dirPath()+"../../Temple_Run/Assets/textures/skybox/skybox.png";
    ...
    Skybox skybox(&cube, &shader, &texture3, camera.getPositionInScene(), glm::vec3(10, 10, 10));
